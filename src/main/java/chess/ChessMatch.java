...
public class ChessMatch {
    ...
    private void undoMove (Position soruce, Position target, Piece capturedPiece) {
        Piece p = board.removePiece(target);
        board.placePiece(p, soruce);
    ...
    private ChessPiece king (Color color) {
        ...
        throw new IllegalStateException("There is no " + color + "Kingt on the board");
